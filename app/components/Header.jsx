...
const Header = ({ isDarkMode }) => {
    ...
    return (
        <div className='w-11/12 max-w-3xl text-center mx-auto h-screen
            ...
            className={`flex items-end gap-2 text-xl md:text-2xl mb-3 font-ovo ${isDarkMode?"text-white/80":""}`}
            >Hi! I'm Fahad
            ...
            className={`text-3xl sm:text-6xl lg:text-[66px] font-ovo ${isDarkMode?"text-white":""}`}>
            ...
            className={`max-w-2xl mx:auto font-ovo ${isDarkMode?"text-white/80":""}`}>
            ...
            <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
                ...
                href="/fahadCV.pdf" download className={`px-10 
